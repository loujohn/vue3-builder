<template>
  <div :class="$style.subbar">
    ...
    <div :class="$style.divider" class="mr-4 d-none d-xl-block"></div>
    ...
    <div :class="$style.amount" class="mr-3 ml-auto d-none d-sm-flex">
      ...
      <div :class="$style.amountGraph">
        <i :class="$style.amountGraphItem" :style="{ height: '80%' }"></i>
        <i :class="$style.amountGraphItem" :style="{ height: '50%' }"></i>
        <i :class="$style.amountGraphItem" :style="{ height: '70%' }"></i>
        <i :class="$style.amountGraphItem" :style="{ height: '60%' }"></i>
        <i :class="$style.amountGraphItem" :style="{ height: '50%' }"></i>
        <i :class="$style.amountGraphItem" :style="{ height: '65%' }"></i>
      </div>
    </div>
    <div :class="$style.amount" class="d-none d-sm-flex">
      ...
      <div :class="$style.amountGraph">
        <i :class="$style.amountGraphItem" :style="{ height: '60%' }"></i>
        <i :class="$style.amountGraphItem" :style="{ height: '65%' }"></i>
        <i :class="$style.amountGraphItem" :style="{ height: '75%' }"></i>
        <i :class="$style.amountGraphItem" :style="{ height: '55%' }"></i>
        <i :class="$style.amountGraphItem" :style="{ height: '100%' }"></i>
        <i :class="$style.amountGraphItem" :style="{ height: '85%' }"></i>
      </div>
    </div>
  </div>
</template>
