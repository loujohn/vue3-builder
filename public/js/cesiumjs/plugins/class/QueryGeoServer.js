    ...
    query(opt) {
        ...
        if (opt.fwEntity) {
            ...
            if (drawEntity.polygon) {
                coordinates = mars3d.draw.attr.polygon.getCoordinates(drawEntity);
                coordinates.push(coordinates[0]);
            }
            else if (drawEntity.rectangle) {
                coordinates = mars3d.draw.attr.rectangle.getOutlineCoordinates(drawEntity);
            }
            else if (drawEntity.ellipse) {
                coordinates = mars3d.draw.attr.ellipse.getOutlineCoordinates(drawEntity);
            }
