...
declare module 'Map2D' {
   ...
   * times in some situations. `Map2D.workerUrl` and `Map2D.workerCount`, if being
   ...
   * `Map2D.clearPrewarmedResources()`. This is only necessary if your web page remains
  ...
  /**
   * Clears up resources that have previously been created by `Map2D.prewarm()`.
  ...
  export class map extends Evented {
    ...
    project(lnglat: LngLatLike): Map2D.Point;

    unproject(point: PointLike): Map2D.LngLat;
    ...
    setStyle(style: Map2D.Style | string, options?: { diff?: boolean | undefined; localIdeographFontFamily?: string | undefined }): this;

    getStyle(): Map2D.Style;
    ...
    addImage(
      name: string,
      image: HTMLImageElement | ArrayBufferView | { width: number; height: number; data: Uint8Array | Uint8ClampedArray } | ImageData | ImageBitmap,
    ...
    addLayer(layer: Map2D.AnyLayer, before?: string): this;

    moveLayer(id: string, beforeId?: string): this;

    removeLayer(id: string): this;

    getLayer(id: string): Map2D.AnyLayer;
    ...
    setLight(options: Map2D.Light, lightOptions?: any): this;

    getLight(): Map2D.Light;
     ...
     */
    queryTerrainElevation(lngLat: Map2D.LngLatLike, options?: ElevationQueryOptions): number | null;

    setFeatureState(feature: FeatureIdentifier | Map2D.MapboxGeoJSONFeature, state: { [key: string]: any }): void;

    getFeatureState(feature: FeatureIdentifier | Map2D.MapboxGeoJSONFeature): { [key: string]: any };

    removeFeatureState(target: FeatureIdentifier | Map2D.MapboxGeoJSONFeature, key?: string): void;
    ...
    getCenter(): Map2D.LngLat;

    setCenter(center: LngLatLike, eventData?: Map2D.EventData): this;

    panBy(offset: PointLike, options?: Map2D.AnimationOptions, eventData?: Map2D.EventData): this;

    panTo(lnglat: LngLatLike, options?: Map2D.AnimationOptions, eventdata?: Map2D.EventData): this;

    getZoom(): number;

    setZoom(zoom: number, eventData?: Map2D.EventData): this;

    zoomTo(zoom: number, options?: Map2D.AnimationOptions, eventData?: Map2D.EventData): this;

    zoomIn(options?: Map2D.AnimationOptions, eventData?: Map2D.EventData): this;

    zoomOut(options?: Map2D.AnimationOptions, eventData?: Map2D.EventData): this;

    getBearing(): number;

    setBearing(bearing: number, eventData?: Map2D.EventData): this;
    ...
    rotateTo(bearing: number, options?: Map2D.AnimationOptions, eventData?: EventData): this;

    resetNorth(options?: Map2D.AnimationOptions, eventData?: Map2D.EventData): this;

    resetNorthPitch(options?: Map2D.AnimationOptions | null, eventData?: Map2D.EventData | null): this;

    snapToNorth(options?: Map2D.AnimationOptions, eventData?: Map2D.EventData): this;
    ...
    fitBounds(bounds: LngLatBoundsLike, options?: Map2D.FitBoundsOptions, eventData?: Map2D.EventData): this;
    ...
    jumpTo(options: Map2D.CameraOptions, eventData?: Map2D.EventData): this;
    ...
    easeTo(options: Map2D.EaseToOptions, eventData?: Map2D.EventData): this;

    flyTo(options: Map2D.FlyToOptions, eventData?: Map2D.EventData): this;
  ...
  export interface MapboxOptions {
    ...
    /** stylesheet location */
    style?: Map2D.Style | string | undefined;
    ...
    /**
     * If specified, map will use this token instead of the one defined in Map2D.accessToken.
     *
     * @default null
     */
  ...
  export class DragRotateHandler {
    constructor(map: Map2D.Map, options?: { bearingSnap?: number | undefined; pitchWithRotate?: boolean | undefined });
  ...
  export class Popup extends Evented {
    constructor(options?: Map2D.PopupOptions);

    addTo(map: Map2D.Map): this;

    isOpen(): boolean;

    remove(): this;

    getLngLat(): Map2D.LngLat;
  ...
  export type AnySourceImpl = GeoJSONSource | VideoSource | ImageSource | CanvasSource | VectorSourceImpl | RasterSource | RasterDemSource;
  ...
  export class GeoJSONSource implements GeoJSONSourceRaw {
    ...
    constructor(options?: Map2D.GeoJSONSourceOptions);
  ...
  export class VideoSource implements VideoSourceRaw {
    ...
    constructor(options?: Map2D.VideoSourceOptions);
  ...
  export class ImageSource implements ImageSourceRaw {
    ...
    constructor(options?: Map2D.ImageSourceOptions);
  ...
  export class LngLat {
    ...
    static convert(input: LngLatLike): Map2D.LngLat;
  ...
  export class LngLatBounds {
    ...
    static convert(input: LngLatBoundsLike): Map2D.LngLatBounds;
    ...
    extend(obj: Map2D.LngLatLike | Map2D.LngLatBoundsLike): this;

    /** Get the point equidistant from this box's corners */
    getCenter(): Map2D.LngLat;

    /** Get southwest corner */
    getSouthWest(): Map2D.LngLat;

    /** Get northeast corner */
    getNorthEast(): Map2D.LngLat;

    /** Get northwest corner */
    getNorthWest(): Map2D.LngLat;

    /** Get southeast corner */
    getSouthEast(): Map2D.LngLat;
  ...
  export class Marker extends Evented {
    constructor(options?: Map2D.MarkerOptions);

    constructor(element?: HTMLElement, options?: Map2D.MarkerOptions);
  ...
  export interface FitBoundsOptions extends Map2D.FlyToOptions {
    linear?: boolean | undefined;
    offset?: Map2D.PointLike | undefined;
    maxZoom?: number | undefined;
    maxDuration?: number | undefined;
  }
  ...
  export interface CustomLayerInterface {
     ...
     */
    onRemove?(map: Map2D.Map, gl: WebGLRenderingContext): void;
     ...
     * @param gl The gl context for the map.
     */
    onAdd?(map: Map2D.Map, gl: WebGLRenderingContext): void;
